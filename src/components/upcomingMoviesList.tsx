...
function UpcomingMoviesList() {
  const { data, error, isFetching } = useFetchUpcomingMoviesQuery(null);
  ...
  if (isFetching) {
    ...
    content = data.results
      // don't include vote_average filter here, as upcoming movies haven't been rated yet
      .filter((movie : Movie) => movie.poster_path !== null && movie.overview !== "")
